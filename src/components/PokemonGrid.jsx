...
const RegionSection = React.memo(({ region, pokemons, selectedIds, togglePokemon, handleRegionSelection, isCollapsed, toggleCollapse }) => {
  // Optimization: Manual counting loop instead of .filter().length
  // This avoids allocating a new temporary array on every render cycle and reduces garbage collection overhead.
  let selectedCount = 0;
