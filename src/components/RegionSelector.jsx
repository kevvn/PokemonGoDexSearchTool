      ...
      <div className="flex overflow-x-auto p-3 gap-3 no-scrollbar max-w-7xl mx-auto px-4 md:px-6">
        {regions.map(region => (
          <button
            ...
            className="flex flex-col items-center min-w-[70px] group shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded-lg"
            aria-label={`Scroll to ${region} region`}
          >
